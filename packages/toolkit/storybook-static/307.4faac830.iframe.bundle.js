...
(self.webpackChunk_contently_toolkit = self.webpackChunk_contently_toolkit || []).push([
  [307],
  {
    '../../node_modules/@mui/material/Autocomplete/Autocomplete.js'(
      ...
      __webpack_require__.d(__webpack_exports__, { A: () => Autocomplete_Autocomplete });
      ...
      var useEventCallback = __webpack_require__(
        ...
        setRef = __webpack_require__('../../node_modules/@mui/utils/esm/setRef/setRef.js');
      ...
      const defaultFilterOptions = (function createFilterOptions(config = {}) {
          const {
            ignoreAccents = !0,
            ignoreCase = !0,
            limit,
          ...
          return (options, { inputValue, getOptionLabel }) => {
            ...
            const filteredOptions = input
              ...
              : options;
            return 'number' == typeof limit ? filteredOptions.slice(0, limit) : filteredOptions;
          };
        })(),
        defaultIsActiveElementInListbox = (listboxRef) => {
          ...
          return (
            ...
            (null == (_listboxRef$current$p = listboxRef.current.parentElement)
              ? void 0
              : _listboxRef$current$p.contains(document.activeElement))
          );
        },
        MULTIPLE_DEFAULT_VALUE = [];
      const useAutocomplete_useAutocomplete = function useAutocomplete(props) {
        const {
        ...
        getOptionLabel = (option) => {
          ...
          return 'string' != typeof optionLabel ? String(optionLabel) : optionLabel;
        };
        const ignoreFocus = react.useRef(!1),
          ...
          resetInputValue = react.useCallback(
            (event, newValue) => {
              ...
              if (multiple) newInputValue = '';
                ...
                newInputValue = 'string' == typeof optionLabel ? optionLabel : '';
              }
          ...
          inputValueIsSelectedValue =
            !multiple && null != value && inputValue === getOptionLabel(value),
          ...
          filteredOptions = popupOpen
                ...
                options.filter(
                  (option) =>
                    ...
                    !(multiple ? value : [value]).some(
                      (value2) => null !== value2 && isOptionEqualToValue(option, value2),
                    ),
                ),
                {
            ...
            : [],
          previousProps = usePreviousProps_usePreviousProps({ filteredOptions, value, inputValue });
        react.useEffect(() => {
        ...
        const setHighlightedIndex = (0, useEventCallback.A)(({ event, index, reason = 'auto' }) => {
            if (
              ...
              onHighlightChange &&
                onHighlightChange(event, -1 === index ? null : filteredOptions[index], reason),
              !listboxRef.current)
            )
              return;
            ...
            if (
              ...
              const element = option,
                scrollBottom = listboxNode.clientHeight + listboxNode.scrollTop,
            ...
            ({ event, diff, direction = 'next', reason = 'auto' }) => {
                ...
                (() => {
                  ...
                  return newIndex < 0
                    ? -1 === newIndex && includeInputInList
                      ? -1
                      : (disableListWrap && -1 !== highlightedIndexRef.current) ||
                          Math.abs(diff) > 1
                        ? 0
                        : maxIndex
                    : newIndex > maxIndex
              ...
              if (
                ...
                if (-1 === nextIndex) inputRef.current.value = inputValue;
                  ...
                  0 === option.toLowerCase().indexOf(inputValue.toLowerCase()) &&
                    inputValue.length > 0 &&
          ...
          syncHighlightedIndex = react.useCallback(() => {
            ...
            if (-1 !== previousHighlightedOptionIndex)
              return void (highlightedIndexRef.current = previousHighlightedOptionIndex);
        ...
        const handleOpen = (event) => {
          ...
          selectNewValue = (event, option, reasonProp = 'selectOption', origin = 'options') => {
          ...
          handleFocusTag = (event, direction) => {
            ...
            (-1 === focusedTag
              ? '' === inputValue && 'previous' === direction && (nextTag = value.length - 1)
                ...
                case 'Escape':
                  popupOpen
                    ...
                    : clearOnEscape &&
                      ...
                      (event.preventDefault(), event.stopPropagation(), handleClear(event));
                  break;
                case 'Backspace':
                  if (multiple && !readOnly && '' === inputValue && value.length > 0) {
                    const index = -1 === focusedTag ? value.length - 1 : focusedTag,
          ...
          handleInputChange = (event) => {
            ...
            (inputValue !== newValue &&
              ...
              '' === newValue
                ? disableClearable || multiple || handleValue(event, null, 'clear')
                : handleOpen(event));
          },
        ...
        return (
          disabledProp && focused && handleBlur(),
          {
            ...
            getClearProps: () => ({ tabIndex: -1, type: 'button', onClick: handleClear }),
            ...
            getOptionProps: ({ index, option }) => {
              ...
              return {
                key:
                  null != (_getOptionKey = null == getOptionKey ? void 0 : getOptionKey(option))
                    ? _getOptionKey
                    : getOptionLabel(option),
                tabIndex: -1,
                role: 'option',
      ...
      function mapToStyles(_ref2) {
        ...
        if (adaptive) {
          ...
          if (
            placement === left ||
            ((placement === enums_top || placement === bottom) && 'end' === variation)
          )
            ((sideX = right),
              (x -=
                (isFixed && offsetParent === win && win.visualViewport
      ...
      var popper_createPopper = popperGenerator({
        ...
        Portal = __webpack_require__('../../node_modules/@mui/material/Portal/Portal.js'),
      ...
      const defaultPopperOptions = {},
        PopperTooltip = react.forwardRef(function PopperTooltip(props, forwardedRef) {
          var _slots$root;
          const {
              anchorEl,
              children,
          ...
          const rtlPlacement = (function flipPlacement(placement, direction) {
            ...
            [resolvedAnchorElement, setResolvedAnchorElement] = react.useState(
          ...
          (react.useEffect(() => {
            ...
            (0, useEnhancedEffect.A)(() => {
              ...
              const popper = popper_createPopper(
                ...
                tooltipRef.current,
                (0, esm_extends.A)({ placement: rtlPlacement }, popperOptions, {
          ...
          const classes = ((ownerState) => {
              const { classes } = ownerState;
              return (0, composeClasses.A)({ root: ['root'] }, getPopperUtilityClass, classes);
            })(props),
        ...
        BasePopper = react.forwardRef(function Popper(props, forwardedRef) {
          ...
          const display = open || !keepMounted || (transition && !exited) ? void 0 : 'none',
          ...
          return (0, jsx_runtime.jsx)(Portal.A, {
            ...
            children: (0, jsx_runtime.jsx)(
              ...
              (0, esm_extends.A)(
                ...
                other,
                {
                  style: (0, esm_extends.A)({ position: 'fixed', top: 0, left: 0, display }, style),
      ...
      var styled = __webpack_require__('../../node_modules/@mui/material/styles/styled.js'),
      ...
      const Popper_excluded = [
        ...
        PopperRoot = (0, styled.Ay)(BasePopper, {
          name: 'MuiPopper',
          slot: 'Root',
          overridesResolver: (props, styles) => styles.root,
        })({}),
        material_Popper_Popper = react.forwardRef(function Popper(inProps, ref) {
          var _slots$root;
          const theme = (0, useThemeWithoutDefault.A)(),
            props = (0, DefaultPropsProvider.b)({ props: inProps, name: 'MuiPopper' }),
            {
              anchorEl,
              component,
              components,
      ...
      var capitalize = __webpack_require__('../../node_modules/@mui/material/utils/capitalize.js');
      ...
      const ListSubheader_excluded = [
        ...
        ListSubheaderRoot = (0, styled.Ay)('li', {
          ...
          (0, esm_extends.A)(
            ...
            'primary' === ownerState.color && { color: (theme.vars || theme).palette.primary.main },
        ...
        ListSubheader = react.forwardRef(function ListSubheader(inProps, ref) {
          const props = (0, DefaultPropsProvider.b)({ props: inProps, name: 'MuiListSubheader' }),
            {
              className,
              color = 'default',
              component = 'li',
            ...
            other = (0, objectWithoutPropertiesLoose.A)(props, ListSubheader_excluded),
            ...
            classes = ((ownerState) => {
              ...
              return (0, composeClasses.A)(slots, getListSubheaderUtilityClass, classes);
            })(ownerState);
          return (0, jsx_runtime.jsx)(
            ListSubheaderRoot,
            (0, esm_extends.A)(
      ...
      var Paper = __webpack_require__('../../node_modules/@mui/material/Paper/Paper.js'),
      ...
      var utils_useForkRef = __webpack_require__(
      ...
      const Chip_chipClasses = (0, generateUtilityClasses.A)('MuiChip', [
        ...
        ChipRoot = (0, styled.Ay)('div', {
          ...
          overridesResolver: (props, styles) => {
            const { ownerState } = props,
              { color, iconColor, clickable, onDelete, size, variant } = ownerState;
            return [
              ...
              {
                [`& .${Chip_chipClasses.deleteIcon}`]:
                  styles[`deleteIcon${(0, capitalize.A)(variant)}Color${(0, capitalize.A)(color)}`],
              },
              styles.root,
          ...
          ({ theme, ownerState }) => {
            const textColor =
              'light' === theme.palette.mode ? theme.palette.grey[700] : theme.palette.grey[300];
            return (0, esm_extends.A)(
              {
                ...
                [`& .${Chip_chipClasses.icon}`]: (0, esm_extends.A)(
                  ...
                  'small' === ownerState.size && { fontSize: 18, marginLeft: 4, marginRight: -4 },
                ...
                [`& .${Chip_chipClasses.deleteIcon}`]: (0, esm_extends.A)(
                  {
                    ...
                    color: theme.vars
                      ...
                      : (0, colorManipulator.X4)(theme.palette.text.primary, 0.26),
                    fontSize: 22,
                    cursor: 'pointer',
                    margin: '0 5px 0 -6px',
                    '&:hover': {
                      color: theme.vars
                        ...
                        : (0, colorManipulator.X4)(theme.palette.text.primary, 0.4),
                    },
                  },
                  'small' === ownerState.size && { fontSize: 16, marginRight: 4, marginLeft: -4 },
                  'default' !== ownerState.color && {
                    color: theme.vars
                      ? `rgba(${theme.vars.palette[ownerState.color].contrastTextChannel} / 0.7)`
                      : (0, colorManipulator.X4)(theme.palette[ownerState.color].contrastText, 0.7),
                    '&:hover, &:active': {
            ...
            (0, esm_extends.A)(
              ...
              'outlined' === ownerState.variant &&
                'default' !== ownerState.color && {
                  ...
                  border: `1px solid ${theme.vars ? `rgba(${theme.vars.palette[ownerState.color].mainChannel} / 0.7)` : (0, colorManipulator.X4)(theme.palette[ownerState.color].main, 0.7)}`,
                  [`&.${Chip_chipClasses.clickable}:hover`]: {
                    backgroundColor: theme.vars
                  ...
                  [`& .${Chip_chipClasses.deleteIcon}`]: {
                    color: theme.vars
                      ...
                      : (0, colorManipulator.X4)(theme.palette[ownerState.color].main, 0.7),
                    '&:hover, &:active': {
                      color: (theme.vars || theme).palette[ownerState.color].main,
                    },
                  },
        ...
        ChipLabel = (0, styled.Ay)('span', {
          ...
          (0, esm_extends.A)(
            ...
            'outlined' === ownerState.variant && { paddingLeft: 11, paddingRight: 11 },
            'small' === ownerState.size && { paddingLeft: 8, paddingRight: 8 },
            'small' === ownerState.size &&
              'outlined' === ownerState.variant && { paddingLeft: 7, paddingRight: 7 },
          ),
        );
      ...
      const Chip_Chip = react.forwardRef(function Chip(inProps, ref) {
        const props = (0, DefaultPropsProvider.b)({ props: inProps, name: 'MuiChip' }),
          {
            avatar: avatarProp,
            className,
          ...
          handleRef = (0, utils_useForkRef.A)(chipRef, ref),
          handleDeleteIconClick = (event) => {
            (event.stopPropagation(), onDelete && onDelete(event));
          },
          clickable = !(!1 === clickableProp || !onClick) || clickableProp,
          component = clickable || onDelete ? ButtonBase.A : ComponentProp || 'div',
          ownerState = (0, esm_extends.A)({}, props, {
            component,
            disabled,
            size,
            color,
            iconColor: (react.isValidElement(iconProp) && iconProp.props.color) || color,
            onDelete: !!onDelete,
            clickable,
            variant,
          }),
                ...
                onKeyUp: (event) => {
                  (event.currentTarget === event.target &&
                    (onDelete && isDeleteKeyboardEvent(event)
                      ? onDelete(event)
                      : 'Escape' === event.key && chipRef.current && chipRef.current.blur()),
      ...
      var inputClasses = __webpack_require__(
      ...
      const Autocomplete_autocompleteClasses = (0, generateUtilityClasses.A)('MuiAutocomplete', [
        'root',
        'expanded',
        'fullWidth',
        'focused',
      ...
      const Autocomplete_excluded = [
        ...
        _excluded3 = ['key'],
        _excluded4 = ['key'],
        AutocompleteRoot = (0, styled.Ay)('div', {
          name: 'MuiAutocomplete',
          slot: 'Root',
          overridesResolver: (props, styles) => {
            const { ownerState } = props,
              { fullWidth, hasClearIcon, hasPopupIcon, inputFocused, size } = ownerState;
            return [
          ...
          [`& .${Autocomplete_autocompleteClasses.inputRoot}`]: {
            ...
            [`.${Autocomplete_autocompleteClasses.hasPopupIcon}.${Autocomplete_autocompleteClasses.hasClearIcon}&`]:
              { paddingRight: 56 },
            [`& .${Autocomplete_autocompleteClasses.input}`]: { width: 0, minWidth: 30 },
          },
          [`& .${inputClasses.A.root}`]: {
            paddingBottom: 1,
          ...
          [`& .${outlinedInputClasses.A.root}`]: {
            ...
            [`.${Autocomplete_autocompleteClasses.hasPopupIcon}.${Autocomplete_autocompleteClasses.hasClearIcon}&`]:
              { paddingRight: 65 },
            [`& .${Autocomplete_autocompleteClasses.input}`]: { padding: '7.5px 4px 7.5px 5px' },
            [`& .${Autocomplete_autocompleteClasses.endAdornment}`]: { right: 9 },
          },
          [`& .${outlinedInputClasses.A.root}.${inputBaseClasses.A.sizeSmall}`]: {
            paddingTop: 6,
            paddingBottom: 6,
            paddingLeft: 6,
            [`& .${Autocomplete_autocompleteClasses.input}`]: { padding: '2.5px 4px 2.5px 8px' },
          },
          ...
          [`& .${filledInputClasses.A.root}.${inputBaseClasses.A.hiddenLabel}`]: {
            paddingTop: 0,
            paddingBottom: 0,
            [`& .${Autocomplete_autocompleteClasses.input}`]: { paddingTop: 16, paddingBottom: 17 },
          },
          [`& .${filledInputClasses.A.root}.${inputBaseClasses.A.hiddenLabel}.${inputBaseClasses.A.sizeSmall}`]:
            {
              [`& .${Autocomplete_autocompleteClasses.input}`]: { paddingTop: 8, paddingBottom: 9 },
            },
          [`& .${Autocomplete_autocompleteClasses.input}`]: {
            flexGrow: 1,
            textOverflow: 'ellipsis',
          ...
          variants: [
            ...
            },
            {
              ...
              style: { [`& .${Autocomplete_autocompleteClasses.input}`]: { opacity: 1 } },
            },
            {
              props: { multiple: !0 },
              style: { [`& .${Autocomplete_autocompleteClasses.inputRoot}`]: { flexWrap: 'wrap' } },
            },
          ],
        }),
        ...
        AutocompletePopper = (0, styled.Ay)(material_Popper_Popper, {
          name: 'MuiAutocomplete',
          slot: 'Popper',
          overridesResolver: (props, styles) => {
            const { ownerState } = props;
        ...
        })(({ theme }) => (0, esm_extends.A)({}, theme.typography.body1, { overflow: 'auto' })),
        ...
        AutocompleteListbox = (0, styled.Ay)('div', {
          name: 'MuiAutocomplete',
          slot: 'Listbox',
        ...
        })({ padding: 0, [`& .${Autocomplete_autocompleteClasses.option}`]: { paddingLeft: 24 } }),
        Autocomplete_Autocomplete = react.forwardRef(function Autocomplete(inProps, ref) {
          var _slotProps$clearIndic, _slotProps$paper, _slotProps$popper, _slotProps$popupIndic;
          const props = (0, DefaultPropsProvider.b)({ props: inProps, name: 'MuiAutocomplete' }),
            {
              autoComplete = !1,
              autoHighlight = !1,
              autoSelect = !1,
              ...
              clearIcon = _ClearIcon ||
                (_ClearIcon = (0, jsx_runtime.jsx)(Close, { fontSize: 'small' })),
              clearOnBlur = !props.freeSolo,
              clearOnEscape = !1,
              clearText = 'Clear',
              closeText = 'Close',
              ...
              openOnFocus = !1,
              openText = 'Open',
              PaperComponent = Paper.A,
              PopperComponent = material_Popper_Popper,
              popupIcon = _ArrowDropDownIcon ||
                (_ArrowDropDownIcon = (0, jsx_runtime.jsx)(ArrowDropDown.A, {})),
              readOnly = !1,
            ...
            other = (0, objectWithoutPropertiesLoose.A)(props, Autocomplete_excluded),
            {
              getRootProps,
              getInputProps,
              getInputLabelProps,
              ...
              (0, esm_extends.A)({}, props, { componentName: 'Autocomplete' }),
            ),
            hasClearIcon = !disableClearable && !disabled && dirty && !readOnly,
            hasPopupIcon = (!freeSolo || !0 === forcePopupIcon) && !1 !== forcePopupIcon,
            { onMouseDown: handleInputMouseDown } = getInputProps(),
            { ref: externalListboxRef } = null != ListboxProps ? ListboxProps : {},
            _getListboxProps = getListboxProps(),
            { ref: listboxRef } = _getListboxProps,
            otherListboxProps = (0, objectWithoutPropertiesLoose.A)(
              _getListboxProps,
              Autocomplete_excluded2,
            ),
            combinedListboxRef = (0, utils_useForkRef.A)(listboxRef, externalListboxRef),
            getOptionLabel =
              getOptionLabelProp ||
              ((option) => {
                var _option$label;
            ...
            classes = ((ownerState) => {
              ...
              return (0, composeClasses.A)(slots, getAutocompleteUtilityClass, classes);
            })(ownerState);
          let startAdornment;
          if (multiple && value.length > 0) {
            const getCustomizedTagProps = (params) =>
              (0, esm_extends.A)({ className: classes.tag, disabled }, getTagProps(params));
            startAdornment = renderTags
              ? renderTags(value, getCustomizedTagProps, ownerState)
              : value.map((option, index) => {
                  const _getCustomizedTagProp = getCustomizedTagProps({ index }),
                    { key } = _getCustomizedTagProp,
                    customTagProps = (0, objectWithoutPropertiesLoose.A)(
          ...
          const renderGroup =
            ...
            renderOption =
              ...
              ((props2, option) => {
                const { key } = props2,
                  otherProps = (0, objectWithoutPropertiesLoose.A)(props2, _excluded4);
                return (0, jsx_runtime.jsx)(
                  'li',
                  (0, esm_extends.A)({}, otherProps, { children: getOptionLabel(option) }),
                  key,
                );
              }),
            renderListOption = (option, index) => {
              ...
              return renderOption(
                (0, esm_extends.A)({}, optionProps, { className: classes.option }),
                option,
          ...
          return (0, jsx_runtime.jsxs)(react.Fragment, {
            children: [
              (0, jsx_runtime.jsx)(
                AutocompleteRoot,
                (0, esm_extends.A)(
                  { ref, className: (0, clsx.A)(classes.root, className), ownerState },
                  getRootProps(other),
                  {
                    children: renderInput({
                      ...
                      InputProps: (0, esm_extends.A)(
                        ...
                        (hasClearIcon || hasPopupIcon) && {
                          endAdornment: (0, jsx_runtime.jsxs)(AutocompleteEndAdornment, {
                              ...
                              hasClearIcon
                                ? (0, jsx_runtime.jsx)(
                                    ...
                                    (0, esm_extends.A)(
                                      {},
                                      getClearProps(),
                                      { 'aria-label': clearText, title: clearText, ownerState },
                                      clearIndicatorSlotProps,
                                      {
                                        className: (0, clsx.A)(
                ...
                ? (0, jsx_runtime.jsx)(
                    ...
                    (0, esm_extends.A)(
                      ...
                      popperSlotProps,
                      {
                        className: (0, clsx.A)(
                          classes.popper,
                          null == popperSlotProps ? void 0 : popperSlotProps.className,
                        ),
                        children: (0, jsx_runtime.jsxs)(
                          AutocompletePaper,
                          (0, esm_extends.A)({ ownerState, as: PaperComponent }, paperSlotProps, {
                            className: (0, clsx.A)(
                              classes.paper,
                              null == paperSlotProps ? void 0 : paperSlotProps.className,
                            ),
                            children: [
...
`),
    ...
    '../../node_modules/@mui/material/IconButton/IconButton.js'(
      ...
      __webpack_require__.d(__webpack_exports__, { A: () => IconButton_IconButton });
      var objectWithoutPropertiesLoose = __webpack_require__(
          '../../node_modules/@babel/runtime/helpers/esm/objectWithoutPropertiesLoose.js',
        ),
        esm_extends = __webpack_require__(
      ...
      const IconButton_iconButtonClasses = (0, generateUtilityClasses.A)('MuiIconButton', [
        'root',
        'disabled',
        'colorInherit',
        'colorPrimary',
      ...
      const _excluded = [
        ...
        IconButtonRoot = (0, styled.Ay)(ButtonBase.A, {
          name: 'MuiIconButton',
          slot: 'Root',
          overridesResolver: (props, styles) => {
            const { ownerState } = props;
            return [
              ...
              'default' !== ownerState.color &&
                styles[`color${(0, capitalize.A)(ownerState.color)}`],
              ownerState.edge && styles[`edge${(0, capitalize.A)(ownerState.edge)}`],
        ...
        IconButton_IconButton = react.forwardRef(function IconButton(inProps, ref) {
          const props = (0, DefaultPropsProvider.b)({ props: inProps, name: 'MuiIconButton' }),
            {
              edge = !1,
              children,
              className,
    ...
    '../../node_modules/@mui/system/useThemeWithoutDefault.js'(
      ...
      exports.A = void 0;
      var React = (function _interopRequireWildcard(e, r) {
        ...
        _styledEngine = __webpack_require__('../../node_modules/@mui/styled-engine/index.js');
      ...
      exports.A = function useTheme(defaultTheme = null) {
...
//# sourceMappingURL=307.4faac830.iframe.bundle.js.map
