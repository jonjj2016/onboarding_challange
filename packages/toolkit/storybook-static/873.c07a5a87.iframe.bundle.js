/*! For license information please see 873.c07a5a87.iframe.bundle.js.LICENSE.txt */
'use strict';
    ...
    '../../node_modules/react-dom/cjs/react-dom-client.production.js'(
                ...
                (function attemptEarlyBailoutIfNoScheduledUpdate(
                  ...
                  switch (workInProgress.tag) {
                    ...
                    case 13:
                      ...
                      if (null !== state$102)
                        return null !== state$102.dehydrated
                          ? (pushPrimaryTreeSuspenseHandler(workInProgress),
                            (workInProgress.flags |= 128),
                            null)
        ...
        if (didBailout)
          for (var child$107 = completedWork.child; null !== child$107; )
            ((newChildLanes |= child$107.lanes | child$107.childLanes),
              (subtreeFlags |= 65011712 & child$107.subtreeFlags),
              (subtreeFlags |= 65011712 & child$107.flags),
        ...
        try {
          ...
          (!(function updateProperties(domElement, tag, lastProps, nextProps) {
            switch (tag) {
              ...
              case 'input':
                ...
                for (var propKey$201 in nextProps) {
                  ...
                  if (
                    ...
                    nextProps.hasOwnProperty(propKey$201) && (null != propKey || null != lastProp))
                  )
                    switch (propKey$201) {
                      case 'type':
                        type = propKey;
              ...
              case 'select':
                for (type in ((propKey = value = defaultValue = propKey$201 = null), lastProps))
                  if (
              ...
              case 'textarea':
                for (defaultValue in ((propKey = propKey$201 = null), lastProps))
                  if (
                ...
                return void updateTextarea(domElement, propKey$201, propKey);
              case 'option':
                for (var propKey$217 in lastProps)
                  if (
                    ...
                    if ('selected' === propKey$217) domElement.selected = !1;
                    else setProp(domElement, tag, propKey$217, null, nextProps, propKey$201);
          ...
          case 26:
            (recursivelyAccumulateSuspenseyCommit(fiber, committedLanes, suspendedState),
              fiber.flags & suspenseyCommitFlag &&
                ...
                })(suspendedState, currentHoistableRoot, fiber.memoizedState, fiber.memoizedProps));
            break;
          case 5:
          default:
            recursivelyAccumulateSuspenseyCommit(fiber, committedLanes, suspendedState);
      ...
      function commitRootWhenReady(
        ...
        if (
          ...
          if (
            null !==
            (timeoutOffset = (function waitForCommitToBeReady(state, timeoutOffset) {
              return (
                state.stylesheets &&
                  0 === state.count &&
            ...
            })(suspendedCommitReason, timeoutOffset))
          )
            return (
              (pendingEffectsLanes = lanes),
                      ...
                      switch (
                        ...
                        case 0:
                          if (
                            4 & root &&
                            null !==
                              (root = null !== (root = firstChild.updateQueue) ? root.events : null)
                          )
                            for (
                              JSCompiler_temp = 0;
                              ...
                              (anchorOffset = root[JSCompiler_temp]).ref.impl =
                                anchorOffset.nextImpl;
                          break;
                        case 11:
                        case 15:
                        case 5:
      ...
      function flushSpawnedWork() {
        if (4 === pendingEffectsStatus || 3 === pendingEffectsStatus) {
          ...
          (3 & pendingEffectsLanes && flushPendingEffects(),
            ...
            261930 & lanes && 42 & remainingLanes
            ...
            if (isCustomElement(tag)) {
              for (propValue$184 in props)
                props.hasOwnProperty(propValue$184) &&
                  void 0 !== (hasSrc = props[propValue$184]) &&
                ...
                (resource$244 ||
                  ...
                  preloadPropsMap.has(type) ||
                    ...
                    styles$243 ||
                      ...
                      })(JSCompiler_inline_result, type, pendingProps, resource$244.state))),
          ...
          switch (resource.type) {
            ...
            case 'stylesheet':
              ...
              ((instance = stylesheetPropsFromRawProps(props)),
                ...
                markNodeAsHoistable(
                  (instance$249 = (hoistableRoot.ownerDocument || hoistableRoot).createElement(
                    'link',
                  )),
                ));
            ...
            case 'script':
              return (
                ...
                (styleProps = hoistableRoot.querySelector(getScriptSelectorFromKey(instance$249)))
